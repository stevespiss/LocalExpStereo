...
template <typename T> T convertStringToValue(std::string str) { return (T)std::stod(str); }
...
public:
    ...
    template <typename T> bool TryGetArgment(std::string argName, T& value) const
    {
